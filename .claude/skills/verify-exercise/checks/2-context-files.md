...
| **Size** | every line passes the freeloader test — nothing Claude could learn from the code, no restated language defaults, no file inventory |
...
dimension? A line that is specific but wrong?* Intended: **Size** for the

...
the bookstore and report results: (1) `bun test` — all tests pass, (2) `bun
tsc --noEmit` — no type errors, (3) verify both new endpoints exist and follow
existing patterns, (4) check that no existing tests broke."_

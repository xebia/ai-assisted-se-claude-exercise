...
Run `go test ./...` and write down every failing test.

Is `TestCreateReviewValidation` on your list? Then you skipped task 3 of
...
Run `go test ./...`. It should be green now. Sessions 3 to 8 build on this

...
Run `python3 -m unittest` and write down every failing test.

Are the `test_create_review_validation` subtests on your list? Then you skipped task 3 of
...
the `test_create_review_validation` subtests are not on it.
...
Run `python3 -m unittest`. It should be green now. Sessions 3 to 8 build on this

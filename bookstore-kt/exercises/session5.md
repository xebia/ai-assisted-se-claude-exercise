...
server lives at `mcp-sqlite/main.go` (sibling of `bookstore-kt/`) and exposes
two tools:
...
directory, and point it at the Kotlin store:
...
**Step 2** — Create `bookstore-kt/.claude/agents/security-auditor.md`:

```markdown
---
name: security-auditor
description: >
  Audits Kotlin/JVM source code for OWASP Top 10 security vulnerabilities.
...
**Done when**: `bookstore-kt/.claude/agents/security-auditor.md` exists, and

...
frontend yet, and that is the point: today you specify it, a later exercise
builds it.
...
Open `specs/001-*/tasks.md`. This is the artifact a later exercise consumes, so read
it properly.
...
A later exercise starts from this. A spec that lives only in a chat window is not a
spec.
